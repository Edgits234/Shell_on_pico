...
public:
    ...
    #else
        int constfps = -1;//let the video player set the fps
    #endif
    ...
    void update() override {
        ...
        ::println(frameIndex / 9600 / 16 / 60,":",(double)(frameIndex) / (double)(9600) / (double)(16) - (double)(frameIndex / 9600 / 16 / 60));
        ...
        if(constfps != -1)
        {
            ...
            frameIndex += constfps * BYTES_PER_FRAME;    
        }else
        {
            //increase by custom fps
