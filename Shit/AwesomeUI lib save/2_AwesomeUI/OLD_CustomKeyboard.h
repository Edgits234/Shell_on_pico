...
bool checkstr(const char* text, const char* find, bool ignore_case = 0, const char* custom = " ")
{
    ...
    if(strcmp(find, "rightarrow") == 0) println(F("RIGHT ARROW CHECKSTR"));
    ...
    while(find[i] != '\0')
    {
        ...
        if(ignore_case)
        {
            if(strcmp(find, "rightarrow") == 0) println((char)UPPERCASE(text[i]),F(" == "),(char)UPPERCASE(find[i]));
                    ...
                    while(true)
                    {
                        ...
                        if(Serial.available() > 0)
                        {
                            ...
                            if(len >= 6 && checkstr(input + len - 6, "/enter", 0, nullptr) && c == ' ')
                            {
                                ...
                                println(F("getting out of the loop character : '"),c,F("' -> ("),(int)(c),F(")"));
