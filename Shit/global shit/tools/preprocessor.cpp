...
bool currentlyLineComment = false;
bool currentlyLongComment = false;
int funcStart         = -1823;
int funcNameStart     = -1823;
int funcNameEnd       = -1823;
bool currentlyInFunc  = false;
bool templateFunc     = false;
bool normalFunc       = false;
...
int lastEqualIndex    = -1823;
int lastOutsideParenthesis = -1823;
std::vector<int> lastEqualsParenthesis;
bool inParenthesisLevel1   = 0;
bool foundEqualParLevel1   = 0;
int funcInputStart    = -1823;
int funcInputEnd      = -1823;
std::string funcInputExcludeDefaultArgs = "";
